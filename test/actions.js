...
test.cb('COMPONENT SHOULD CALL ONE LISTENER', t => {
  t.plan(1);
...
test.cb('COMPONENT SHOULD CALL THE SECOND LISTENER BEFORE THE FIRST ONE', t => {
  t.plan(2);
...
test.cb('COMPONENT SHOULD CALL 3 LISTENERS BY CANCELING THE FIRST ONE AFTER HIS FIRST CALL', t => {
  t.plan(3);
